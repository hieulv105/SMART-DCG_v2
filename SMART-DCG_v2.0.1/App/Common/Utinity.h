...
#define MCU_FIRMWARE_VER 201			// v2.0.1 (MCU firmware version)
...
#define MPU_WDT_TIMECYCLE		20		// 20 seconds 1 pulse

#define MPU_RESET_TIME			10 		// Time shutdown power to restart MPU (S) default 10 Sec
#define MPU_WAIT_FEEDBACK_TIME	120 	// 02' - Time wait MPU feedback after restart (S)
#define MPU_WDT_OVERTIME		600 	// 10' - Watch dog overtime (S)
#define MPU_WDT_DELAY_TIME		120 	// 02' - Watch dog starting delay time (S)
#define MPU_WDT_UPDATE_TIME		900 	// 15' - Suspended time for MPU update feature (S)

#define LED_DELAY_200MS	(0.2 * (1000 / LED_TASK_TICK_TIME))
